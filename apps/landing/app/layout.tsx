...
export const metadata: Metadata = {
  ...
  description: 'Simply: plataforma financiera AI-first para personas, empresas, cripto, tarjetas, inversiones, financiación y Diamond Black.',
  openGraph: {
    title: 'Simply | Tu dinero, sin fricción',
    description: 'Plataforma financiera AI-first para personas y empresas.',
    url: SITE_URL, siteName: 'Simply', locale: 'es_AR', type: 'website',
  },
