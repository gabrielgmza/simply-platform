...
import { Button, CardElevated, StepIndicator, FormField, Input } from "@simply/ui";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-white/60">Solo te pedimos tu email para guardar la operación.</p>
      </div>
      ...
      <p className="text-center text-xs text-white/40">Tus datos quedan guardados en Simply by PaySur</p>
    </div>
  );
}
